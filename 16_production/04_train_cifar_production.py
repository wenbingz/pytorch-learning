"""
Production-style CIFAR-10 training: grad accumulation + StepLR + EMA.
...
class Config:
    ...
    ckpt_path: str = "runs/cifar10_production/ckpt.pt"
...
def parse_args() -> Config:
    parser = argparse.ArgumentParser(description="CIFAR-10 with grad accum + scheduler + EMA")
...
def main() -> None:
    ...
    print("next: python3 16_production/05_deploy_cifar_checkpoint.py --weights ema")
